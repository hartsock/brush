...
pub struct Shell<SE: extensions::ShellExtensions = extensions::DefaultShellExtensions> {
    ...
    /// Injected command-interception behavior.
    #[cfg_attr(
        feature = "serde",
...
impl<SE: extensions::ShellExtensions> Shell<SE> {
    ...
    /// Returns the shell's configured command interceptor. The shell consults it
    /// automatically; hosts rarely need to call this directly.
